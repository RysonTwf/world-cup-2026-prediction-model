...
import { matchProb, expectedScore, HOME_ADV } from "./elo.mjs";
...
const SEED = existsSync(seedsFile)
  ...
  : (() => { console.warn("[backtest] data/seeds.json not found — run node build-seeds.mjs first. Using flat 1500 prior."); return {}; })();
const BURN_IN = 150;
